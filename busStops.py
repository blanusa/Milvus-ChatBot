...
def run_bus_stops_insertion():
    ...
    fields = [
        ...
        FieldSchema(name='latitude', dtype=DataType.FLOAT, max_length=500),
        FieldSchema(name='longitude', dtype=DataType.FLOAT, max_length=500),
